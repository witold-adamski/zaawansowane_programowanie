...
class Brewery:
    def __init__(self, id: str, name: str, brewery_type: str,
                 street: str, address_2: str, address_3: str, city: str,
                 state: str, county_province: str, postal_code: str,
                 country: str, longitude: str, latitude: str,
...
url = f'https://api.openbrewerydb.org/breweries?by_city={city}' \
    if city else f'https://api.openbrewerydb.org/breweries'
